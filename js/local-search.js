      ...
      success : function(xmlResponse) {
        ...
        $input.on('input', function() {
          ...
          dataList.forEach(function(data) {
            ...
            if (isMatch) {
              resultHTML += '<a href=\'' + data_url + '\' class=\'list-group-item list-group-item-action search-list-item\'>';
              resultHTML += '<span class=\'font-weight-bolder search-list-title\'>' + orig_data_title + '</span>';
